...
using Routes.Tests.Integration.Fixtures;

namespace Routes.Tests.Integration.Tests
{
    public class UserTests
    {
        // private readonly TestContext _context;
        // private readonly UsuarioViewModel _userAdmin;
        // public UserTests()
        // {
        ...
        //     UsuarioViewModel dto = _userAdmin;
        //     dto.Id = 13;
        ...
        //     var json = JsonConvert.SerializeObject(new UsuarioViewModel { PrimeiroNome = user, Senha = "YWRtaW4=", RefreshTokenExpiryTime = DateTime.Now });
        //     var stringContent = new StringContent(json, UnicodeEncoding.UTF8, "application/json");
